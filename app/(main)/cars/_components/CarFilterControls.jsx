...
const CarFilterControls = (
    ...
    const filterSections = [
        ...
        },
        {
            id: "fuelType",
            title: "Fuel Type",
            options: filters.fuelTypes.map((fuel) => ({value: fuel, label: fuel})),
    ...
    return (
        <div className={`space-y-6`}>
            <div className={`space-y-4`}>
                ...
                <div className={`px-2`}>
                    <Slider min={filters.priceRange.min} max={filters.priceRange.max} step={100} value={priceRange}
                        ...
                        {section.options.map((option) => (
                            <Badge
                                ...
                                className={`cursor-pointer px-3 py-1
                                    ${section.currentValue === option.value ? "bg-blue-100 hover:bg-blue-200 text-blue-900" : "bg-white hover:bg-gray-100 text-gray-700"}`}
                            >
                                {option.label}
                                {
